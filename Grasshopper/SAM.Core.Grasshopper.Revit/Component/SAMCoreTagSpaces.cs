    ...
    public class SAMCoreTagSpaces : SAMTransactionalChainComponent
    {
        ...
        protected override ParamDefinition[] Inputs
        {
            get
            {
                ...
                result.Add(new ParamDefinition(new global::Grasshopper.Kernel.Parameters.Param_String() { Name = "_templateNames", NickName = "_templateNames", Description = "View Template Names", Access = GH_ParamAccess.list }, ParamRelevance.Binding));
                result.Add(new ParamDefinition(new global::Grasshopper.Kernel.Parameters.Param_GenericObject() { Name = "_spaceTagType", NickName = "_spaceTagType", Description = "Revit SpaceTagType", Access = GH_ParamAccess.item }, ParamRelevance.Binding));
        ...
        protected override ParamDefinition[] Outputs
        {
            ...
            {
                List<ParamDefinition> result = new List<ParamDefinition>();
                result.Add(new ParamDefinition(new RhinoInside.Revit.GH.Parameters.Element() { Name = "spaceTags", NickName = "spaceTags", Description = "Revit SpaceTags", Access = GH_ParamAccess.list }, ParamRelevance.Binding));
                return result.ToArray();
            }
        }
