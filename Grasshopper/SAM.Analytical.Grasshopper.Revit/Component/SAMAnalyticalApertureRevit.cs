    ...
    public class SAMAnalyticalApertureRevit : SAMTransactionalChainComponent
    {
        ...
        protected override ParamDefinition[] Inputs
        {
            get
            {
                ...
                result.Add(ParamDefinition.FromParam(new GooApertureParam() { Name = "_aperture", NickName = "_aperture", Description = "SAM Analytical Aperture", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
        ...
        protected override ParamDefinition[] Outputs
        {
            ...
            {
                List<ParamDefinition> result = new List<ParamDefinition>();
                result.Add(ParamDefinition.FromParam(new RhinoInside.Revit.GH.Parameters.FamilyInstance() { Name = "familyInstance", NickName = "familyInstance", Description = "Revit familyInstance", Access = GH_ParamAccess.item }, ParamVisibility.Binding));
                return result.ToArray();
            }
        }
