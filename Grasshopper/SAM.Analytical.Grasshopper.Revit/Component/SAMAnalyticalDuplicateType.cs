    ...
    public class SAMAnalyticalDuplicateType : SAMTransactionalChainComponent
    {
        ...
        protected override ParamDefinition[] Inputs
        {
            get
            {
                ...
                result.Add(new ParamDefinition(new global::Grasshopper.Kernel.Parameters.Param_String() { Name = "_name", NickName = "_name", Description = "Name", Access = GH_ParamAccess.item }, ParamRelevance.Binding));
                ...
                result.Add(new ParamDefinition(new global::Grasshopper.Kernel.Parameters.Param_String() { Name = "_parameterNames_", NickName = "_parameterNames_", Description = "Parameter Names", Optional = true, Access = GH_ParamAccess.list }, ParamRelevance.Occasional));
        ...
        protected override ParamDefinition[] Outputs
        {
            ...
            {
                List<ParamDefinition> result = new List<ParamDefinition>();
                result.Add(new ParamDefinition(new RhinoInside.Revit.GH.Parameters.ElementType() { Name = "elemenType", NickName = "elemenType", Description = "Revit ElemenType", Access = GH_ParamAccess.item }, ParamRelevance.Binding));
                return result.ToArray();
            }
        }
