    ...
    public class SAMAdjacencyClusterRevit : SAMTransactionalChainComponent
    {
        ...
        protected override ParamDefinition[] Inputs
        {
            get
            {
                ...
                result.Add(new ParamDefinition(new GooAdjacencyClusterParam() { Name = "_adjacencyCluster", NickName = "_adjacencyCluster", Description = "SAM Analytical AdjacencyCluster", Access = GH_ParamAccess.item }, ParamRelevance.Binding));
