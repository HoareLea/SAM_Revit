    ...
    public class SAMCoreCreateSheets : SAMTransactionalChainComponent
    {
        ...
        protected override ParamDefinition[] Inputs
        {
            get
            {
                ...
                result.Add(new ParamDefinition(new RhinoInside.Revit.GH.Parameters.View() { Name = "_referenceViewSheet", NickName = "_referenceViewSheet", Description = "Elements to be deleted", Access = GH_ParamAccess.item }, ParamRelevance.Binding));
                result.Add(new ParamDefinition(new global::Grasshopper.Kernel.Parameters.Param_String() { Name = "_templateNames", NickName = "_templateNames", Description = "View Templates Names", Access = GH_ParamAccess.list }, ParamRelevance.Binding));
        ...
        protected override ParamDefinition[] Outputs
        {
            ...
            {
                List<ParamDefinition> result = new List<ParamDefinition>();
                result.Add(new ParamDefinition(new RhinoInside.Revit.GH.Parameters.View() { Name = "viewSheets", NickName = "viewSheets", Description = "Revit View Sheets", Access = GH_ParamAccess.list }, ParamRelevance.Binding));
                return result.ToArray();
            }
        }
