...
//        /// </summary>
//        public override Guid ComponentGuid => new Guid("fa6df00f-dc04-4ba3-9230-138ff828a696");
...
//          : base("SAMAnalytical.UpdateConstructions", "SAManalytical.UpdateConstructions",
...
//            {
//                List<ParamDefinition> result = new List<ParamDefinition>();
//                result.Add(new ParamDefinition(new GooAnalyticalObjectParam() { Name = "analytical", NickName = "analytical", Description = "SAM Analytical Object", Access = GH_ParamAccess.item }, ParamRelevance.Binding));
...
//            Analytical.Modify.SetConstructionsDefaultPanelType(adjacencyCluster, false);
