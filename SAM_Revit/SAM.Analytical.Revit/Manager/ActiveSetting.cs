...
namespace SAM.Analytical.Revit
{
    public static partial class ActiveSetting
    {
        ...
        public static Setting GetDefault()
        {
            ...
            parameterMap_General.Add(SpaceParameter.Occupancy, typeof(Autodesk.Revit.DB.Mechanical.Space), "SAM_NoPeople");
            ...
            parameterMap_General.Add(MaterialParameter.DefaultThickness, typeof(FamilyInstance), "SAM_Material_Width");
            ...
            parameterMap_Cooling.Add(SpaceSimulationResultParameter.DesignLoad, typeof(Autodesk.Revit.DB.Mechanical.Space), "SAM_DesSpecSensCoolLoad", null, "[SAM.Analytical.Query.SpecificDesignLoad(Object_1)]");
            parameterMap_Cooling.Add(SpaceSimulationResultParameter.DesignLoad, typeof(Autodesk.Revit.DB.Mechanical.Space), "='SAM' + [SAM.Core.Revit.Query.ParameterNamePrefix(Object_1)] + '_DesSensCoolingLoad'", null, "[SAM.Analytical.Query.SpecificLoad(Object_1)]");
            ...
            parameterMap_Heating.Add(SpaceSimulationResultParameter.DesignLoad, typeof(Autodesk.Revit.DB.Mechanical.Space), "SAM_DesSpecSensHeatLoad", null, "[SAM.Analytical.Query.SpecificDesignLoad(Object_1)]");
            parameterMap_Heating.Add(SpaceSimulationResultParameter.DesignLoad, typeof(Autodesk.Revit.DB.Mechanical.Space), "='SAM' + [SAM.Core.Revit.Query.ParameterNamePrefix(Object_1)] + '_Height'", null, "[SAM.Analytical.Query.Height(Object_1)]");
