...
namespace SAM.Analytical.Revit
{
    ...
    {
        //public static List<Shell> Shells_Obsolete(this Document document, IEnumerable<Autodesk.Revit.DB.Mechanical.Space> spaces = null, double offset = 0.1, double snapTolerance = Core.Tolerance.MacroDistance, double tolerance = Core.Tolerance.Distance)
        //{
        //    if (document == null)
        //        return null;
